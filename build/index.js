...
const onclickFunctions = new _modules_OnclickFunctions__WEBPACK_IMPORTED_MODULE_2__["default"](); // const search = new Search()
...
class OnclickFunctions {
  ...
  async addLike(currentLikeButton) {
    ...
    try {
      ...
      const response = await axios.post(`${blogData.root_url}/wp-json/blog/v1/like`, data, config);
  ...
  async removeLike(currentLikeButton) {
    ...
    try {
      ...
      const response = await axios.delete(`${blogData.root_url}/wp-json/blog/v1/like`, config);
  ...
  async getResults() {
    ...
    try {
      const response = await axios.get(`${blogData.root_url}/wp-json/blog/v1/search?search=${this.searchBar.value}`);
      let postResult = "";
      let pageResult = "";
